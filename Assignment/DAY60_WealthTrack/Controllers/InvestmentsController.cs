...
using DAY60_WealthTrack.Data;
using DAY60_WealthTrack.Models;
using DAY60_WealthTrack.ViewModel;

namespace DAY60_WealthTrack.Controllers
{
    public class InvestmentsController : Controller
    {
        private readonly DAY60_WealthTrackContext _context;

        public InvestmentsController(DAY60_WealthTrackContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create(InvestmentCreateViewModel investment)
        {
            if (ModelState.IsValid)
            {
                var investmentToCreate = new Investment()
                {
                ...
                _context.Investment.Add(investmentToCreate);
